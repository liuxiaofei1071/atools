...
def create_record(*args):
    """添加一种文件类型"""
    sql = """INSERT INTO cocoa.cc_content_type(`id`,`filetype`,`name`,`suffix`,`create_time`,`create_by`,`update_time`,`update_by`)
...
def select_all_record():
    """查询所有文件类型"""
    sql = "SELECT `id`,`filetype`,`name`,`suffix` FROM cocoa.cc_content_type"
...
def del_one_record(_id):
    sql = "DELETE FROM cocoa.cc_content_type WHERE id=%s"
